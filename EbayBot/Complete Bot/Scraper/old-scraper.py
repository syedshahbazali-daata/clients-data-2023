...
# install multiple modules at once: pip install grequests undetected_chromedriver xextract bs4
print(grequests.__version__)  # 0.6.0
quit()
start_from = 1
...
while True:
    ...
    main_url = re.sub(r"from=\d+", "from=1", main_url)
