...
def amazon_scraper(url):
    ...
    fixed_price = get_text_soon('//*[@id="corePriceDisplay_desktop_feature_div"]//span[@class="a-price-fraction"]/..').upper()
    fixed_price = fixed_price.replace("AED", "").replace("\n", ".")

    old_price = get_text_soon(
        '//*[@id="corePriceDisplay_desktop_feature_div"]//*[contains(text(), "List Price:") or contains(text(), "Typical price:")]/span').upper()
...
df_1.to_csv('products.csv', index=False)
