...
def home():
    ...
    live_extended_url = "https://www.youtube.com/watch?v=" + get_file_data("live_video_url.txt")[0]
    return render_template("index.html", live_video_url=live_extended_url, playlist_url=get_file_data("playlist.txt")[0])
